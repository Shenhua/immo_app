...
def generate_amortization_schedule(
    ...
    return {
        ...
        "interet": list(interets),
        "principal": list(principals),
        "assurance": [round(pmt_ins, 2)] * n,
        "paiement_total": [round(pmt_total, 2)] * n,
        "capital_restant_fin": list(balances),
        "pmt_assur": pmt_ins,
        "pmt_total": pmt_total,
        "interets": list(interets),
